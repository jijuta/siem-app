...
import { Plus, Search, Building2, Users, Pencil, Trash2, Network } from 'lucide-react'
...
export default function DepartmentManagementPage() {
  ...
  const handleSubmit = async () => {
    // Validation
    if (!formData.company_id || !formData.code || !formData.name.ko || !formData.name.en || !formData.name.ja || !formData.name.zh) {
